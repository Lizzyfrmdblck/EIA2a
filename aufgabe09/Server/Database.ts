...
if (process.env.NODE_ENV == "production") {
    databaseURL = "mongodb+srv://milchtrinker:testpassword@eia2-57vpd.mongodb.net/eia2";
    databaseName = "eia2";
...
export function searchMatrikel(_matnumber: MatrikelData, _callback: Function): void {
